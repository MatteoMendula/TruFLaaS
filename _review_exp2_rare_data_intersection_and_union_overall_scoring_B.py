...
def experiment_rare_cases(experiment_counter, n_specials, final_data):
    ...
    for itr in range(iterations):
        ...
        save_2d_matrix_to_csv_file(f'./results/exp2B_rare_data_intersection_and_union_overall_scoring/{n_rares}_rares/csvs/', f'test_{experiment_counter}.csv', csv_results)
